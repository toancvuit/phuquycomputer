...
import {lenovoPCGetList} from '../../../action';
const _ = require('lodash');


class Lenovo extends React.Component {
    componentDidMount() {
        this.props.lenovopcgetlist();
    }
    render () {
...
function ShowImageLaptop(props) {
    ...
    if(props.random ===0) {
    return (<img src={process.env.PUBLIC_URL + "/main/lenovo/lenovo0.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>);
    }
    else if (props.random ===1) {
    return (<img src={process.env.PUBLIC_URL + "/main/lenovo/lenovo1.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>)
    }else if (props.random ===2) {
    return (<img src={process.env.PUBLIC_URL + "/main/lenovo/lenovo2.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>)
    }else {
        return (<img src={process.env.PUBLIC_URL + "/main/lenovo/lenovo3.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>)
    }
}
const mapStateToProps = (state, props) => {
    return {
        data: state.pclenovo.data,
