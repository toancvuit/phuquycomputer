...
import {hpPcGetList} from '../../../action';
const _ = require('lodash');


class Hp extends React.Component {
    componentDidMount() {
        this.props.hppcgetlist();
    }
    render () {
...
function ShowImageLaptop(props) {
    ...
    if(props.random ===0) {
    return (<img src={process.env.PUBLIC_URL + "/main/hp/hp0.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>);
    }
    else if (props.random ===1) {
    return (<img src={process.env.PUBLIC_URL + "/main/hp/hp1.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>)
    }else if (props.random ===2) {
    return (<img src={process.env.PUBLIC_URL + "/main/hp/hp2.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>)
    }else {
        return (<img src={process.env.PUBLIC_URL + "/main/hp/hp3.PNG"} className="card-img-top width-image-mayin" alt="laptop"/>)
    }
}
const mapStateToProps = (state, props) => {
    return {
        data: state.pchp.data,
